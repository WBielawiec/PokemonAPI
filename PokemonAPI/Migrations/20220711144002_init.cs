        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TM = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackpackItems", x => new { x.BackpackId, x.ItemId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackpackMoves", x => new { x.BackpackId, x.MoveId });
                    table.ForeignKey(
                        name: "FK_BackpackMoves_Backpacks_BackpackId",
                        column: x => x.BackpackId,
                        principalTable: "Backpacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BackpackMoves_Moves_MoveId",
                        column: x => x.MoveId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BackpackPokemons", x => new { x.BackpackId, x.PokemonId });
                    table.ForeignKey(
                        name: "FK_BackpackPokemons_Backpacks_BackpackId",
                        column: x => x.BackpackId,
                        principalTable: "Backpacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BackpackPokemons_Pokemons_PokemonId",
                        column: x => x.PokemonId,
                        principalTable: "Pokemons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BackpackMoves_MoveId",
                table: "BackpackMoves",
                column: "MoveId");

            migrationBuilder.CreateIndex(
                name: "IX_BackpackPokemons_PokemonId",
                table: "BackpackPokemons",
                column: "PokemonId");
